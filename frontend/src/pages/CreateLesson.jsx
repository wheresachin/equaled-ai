        ...
        <main className="flex-1 pt-24 px-8 pb-8 overflow-y-auto">
            ...
            <div className="max-w-4xl mx-auto">
                <header className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 high-contrast:text-yellow-400">Create New Lesson</h1>
                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 high-contrast:bg-gray-900 high-contrast:border-gray-800 space-y-6">
                    ...
                    <div className="flex justify-end pt-4 border-t border-gray-100 high-contrast:border-gray-800">
                        <button 
                            type="submit"
                            disabled={loading}
                            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-bold transition-all shadow-lg high-contrast:bg-yellow-400 high-contrast:text-black disabled:opacity-50"
                        >
